<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-password-field id="password" name="password" autocomplete="new-password" required />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label for="password_confirmation" value="Потвърди парола" />

            <x-password-field id="password_confirmation" name="password_confirmation" autocomplete="new-password" required />
